...
// Updated Locations List (Kurunegala & Ragama Added)
const tourismLocations = [
    ...
    { id: 5, name: "Kurunegala Clock Tower", coords: [80.3647, 7.4871], desc: "The bustling heart of Wayamba." },
    { id: 6, name: "Ragama Sacred Heart Church", coords: [79.9197, 7.0311], desc: "Major transit and historical hub." }
];
